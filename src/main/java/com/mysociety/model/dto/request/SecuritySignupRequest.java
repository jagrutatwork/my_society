...
public class SecuritySignupRequest {
	...
	public String toString() {
		return "SecuritySignupRequest [name=" + name + ", phoneNumber=" + phoneNumber + ", email=" + email
				+ ", password=" + password + ", societyId=" + societyId + "]";
	}
	

	public SecuritySignupRequest(@NotBlank(message = "Name is required") String name,
